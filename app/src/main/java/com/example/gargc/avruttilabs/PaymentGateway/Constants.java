package com.example.gargc.avruttilabs.PaymentGateway;



public class Constants {

    public static final String M_ID = "Avrutt78305240735823"; //Paytm Merchand Id we got it in paytm credentials
